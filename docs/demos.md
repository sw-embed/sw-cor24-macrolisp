...
| `iteration.l24` | Named let, do, case, letrec, values, assert, format, strings | `just eval demos/iteration.l24` | Iteration, dispatch, multiple returns, assertions, string ops |
